    ...
    <nav class="navbar navbar-dark fixed-top" style="background: black; font-size:14px">
       <img src="../img/image_1.png" style="width: 2.99rem; height:2.87rem;">
        ...
        <div class="dropdown">
          ...
          <a class="navbar-brand" href="" role="button" id="dropdownMenuLink" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" style="font-size:20px"><b><?php echo $nome; ?></b><span class="badge badge-light" style="margin:2px; background:yellow;">9</span>
  <span class="sr-only">Mensagens não lidas</span><img src="<?php echo $foto; ?>" style="width:52px; height: 38px; padding:0 8px; border-radius:100%;"></a>
