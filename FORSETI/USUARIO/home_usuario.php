...
<div class="row" style="padding:50px 0;">
  ...
  <div class="card green">
    <a href="atualizar_inf.php?cd=<?php echo $_SESSION['cd'];?> " style="text-decoration: none; color:black; display: block;">
      <h2>Atualizar minhas informações</h2>
      <img class="image" src="../img/atualizacao.png" alt="money" />
    </a>
  </div>
</a>
  <div class="card blue">
    <a href="acompanhe_progresso.php" style="text-decoration: none; color:black; display: block;">
      <h2>Acompanhar seu processo</h2>
      <img class="image" src="../img/processo.png" alt="settings" />
    </a>
  </div>

  <div class="card red">
    <a href="contratar_profissional.php" style="text-decoration: none; color:black; display: block;">
      <h2>Contratar um profissional</h2>
      <img class="image" src="../img/contrato.png" alt="article" />
    </a>
  </div>
</div>
<br>
