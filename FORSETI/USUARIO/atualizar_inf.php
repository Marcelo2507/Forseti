...
<div class ="container" style="margin:-20px auto; padding: 50px 0;">
  ...
  <form class="form" method="post" action="../php/edit.php" onsubmit="return validarFormulario()">
    <input type="hidden" name="cd" value="<?php echo $cd; ?>">
    <div class="form-item">
    <label class="label"> Nome: </label><br>
    <input class="input" type="text" name="nm_pessoa" placeholder=" Digite seu nome" value="<?php echo $nome; ?>"><br>
    </div>
    ...
    <input class="input" type="text" name="telefone" placeholder=" (00)12345-6789" value ="<?php echo $telefone; ?>"><br>
    </div>
    ...
    <div class="form-group">
      <label for="exampleInputEmail1"> CEP </label><br>
      <input class="input" placeholder=" 11760-000 " value ="<?php echo $cep; ?>" name="cep">
    </div>
